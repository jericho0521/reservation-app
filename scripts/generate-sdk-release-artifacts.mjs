...
function renderReleaseNotes() {
  return [
    ...
    "- Final standalone frontend/backend extraction and backend release tagging are not complete. The frontend consumer readiness and prepared-artifact install/build proof, extraction manifest, dry-run extraction plan, extracted-workspace readiness model, extracted-install proof harness, SQL ownership inventory, migration bundle manifest, migration index, standalone JWT/JWKS verifier, bounded JWKS cache tests, and passed disposable database strict proof are still short of the final product split; they do not create or populate the future frontend or backend repositories, configure a live auth provider, prove provider operational key rotation, deploy a backend, publish packages, prove registry install, or prove live parity.",
