...
The current source candidate is `0.2.0` with required migration `000037`. It remains a candidate until independent full-day acceptance evidence is completed and accepted; the checked-in pending record is not release proof.
