...
function renderReleaseNotes() {
  return [
    ...
    "- Publish/pilot readiness should require strict live backend proof, strict database live proof, strict SDK/direct live backend parity, and strict registry install proof. External frontend install/build proof belongs in a separate frontend repository or branch.",
