-- Transaction-safe reservation creation RPC for Supabase hosts.
--
-- Apply after the base reservation schema. The function returns jsonb so host
-- apps can map stable error codes without relying on PostgreSQL exception text.
